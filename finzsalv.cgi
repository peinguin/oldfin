...
print '<div  style="float:left; width: 90%; text-align: center; background-color: #ffffff;">С А Л Ь Д О В А . В І Д О М І С Т Ь за '.$smonth.' '.$syearp.'р.</div>';
}else{
print '<div  style="float:left; width: 7%; text-align: left; page-break-before: always; background-color: #ffffff;">Лист '.$numpage.'</div>';
print '<div  style="float:left; width: 90%; text-align: center; background-color: #ffffff;">С А Л Ь Д О В А Я .  В Е Д О М О С Т Ь за '.$smonth.''.$date.' '.$syearp.'р.</div>';
}
print ' <div  style="clear:both;"></div>';

if ($mova eq "Ua") {

print '<div align="center" style="border: 1px solid #000000; float:left; width: 31%; background-color: #ffffff;">Вхідне сальдо</div>';
print '<div align="center" style="border: 1px solid #000000; float:left; width: 22%; background-color: #ffffff;">Обороти пот.місяця</div>';
print '<div align="center" style="border: 1px solid #000000; float:left; width: 22%; background-color: #ffffff;">Обороти з поч. року</div>';
print '<div align="center" style="border: 1px solid #000000; float:left; width: 22%; background-color: #ffffff;">Кінцеве сальдо</div>';
print ' <div  style="clear:both;"></div>';

print '<div align="center" style="border: 1px solid #000000; float:left; width: 4%; background-color: #ffffff;">Рах.</div</div>';
print '<div align="center" style="border: 1px solid #000000; float:left; width: 4%; background-color: #ffffff;">/СубР</div>';

print '<div align="center" style="border: 1px solid #000000; float:left; width: 11%; background-color: #ffffff;">Дебет</div>';
print '<div align="center" style="border: 1px solid #000000; float:left; width: 11%; background-color: #ffffff;">Кредіт</div>';

print '<div align="center" style="border: 1px solid #000000; float:left; width: 11%; background-color: #ffffff;">Дебет</div>';
print '<div align="center" style="border: 1px solid #000000; float:left; width: 11%; background-color: #ffffff;">Кредіт</div>';

print '<div align="center" style="border: 1px solid #000000; float:left; width: 11%; background-color: #ffffff;">Дебет з п.р.</div>';
print '<div align="center" style="border: 1px solid #000000; float:left; width: 11%; background-color: #ffffff;">Кредіт з п.р.</div>';
...
print '<div  style="float:left; width: 11%; text-align: right; background-color: #ffffff;"><font color="#0000ff" size="3">'.sprintf("%10.2f",$salpochd).'</font></div>';
print '<div  style="float:left; width: 11%; text-align: right; background-color: #ffffff;"><font color="#0000ff" size="3">'.sprintf("%10.2f",$salpochk).'</font></div>';

print '<div  style="float:left; width: 11%; text-align: right; background-color: #ffffff;"><font color="#000000" size="3">'.sprintf("%10.2f",$itdebsch).'</font></div>';
print '<div  style="float:left; width: 11%; text-align: right; background-color: #ffffff;"><font color="#000000" size="3">'.sprintf("%10.2f",$itkredsch).'</font></div>';

print '<div  style="float:left; width: 11%; text-align: right; background-color: #ffffff;"><font color="#000000" size="3">'.sprintf("%10.2f",($itdspr+$itdebsch)).'</font></div>';
print '<div  style="float:left; width: 11%; text-align: right; background-color: #ffffff;"><font color="#000000" size="3">'.sprintf("%10.2f",($itkspr+$itkredsch)).'</font></div>';
...
# загальні змінні для рахунку
#---------------
my ($mbooc,$msummaop,$midzak);

$sqlkau1 ='(SELECT t1.idzak AS idzak FROM '.$base.' AS t1 WHERE oc="'.$choice.'" and coc="'.$choicecoc.'") UNION (SELECT t2.idzak AS idzak  FROM '.$basesal.' AS t2 WHERE oc="'.$choice.'" and coc="'.$choicecoc.'")';
$sqlkau1 = $sqlkau1 . ' ORDER BY idzak';
$sthkau1 = $dbhr->prepare($sqlkau1);
$sthkau1->execute();
while (($midzakdis) = $sthkau1->fetchrow()){;
...
my ($sqlk,$sthk,$salkau);
$sqlk ='SELECT booc,summa FROM '.$base.'  WHERE oc="'.$choice.'" and coc="'.$choicecoc.'" and idzak="'.$midzakdis.'"';
...
$sqlk ='SELECT saldo,booc FROM '.$basesal.' WHERE oc="'.$choice.'" and coc="'.$choicecoc.'" and  idzak="'.$midzakdis.'"';
#print $sqlk;
$sthk = $dbhr->prepare($sqlk);
$sthk->execute();
