...
$sqlr ='SELECT id,oc,coc,kc,ckc,booc,data,kau,kaukc,summa,priznak,dok,zakname,idzak FROM '.$base.'  WHERE oc="'.$choice.'" and coc="'.$choicecoc.'" and dok="'.$mdokdis.'"';
$sqlr = $sqlr . ' ORDER BY dok,data,kc,ckc,dok';
$sthr = $dbhr->prepare($sqlr);
$sthr->execute();
