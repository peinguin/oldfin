...
#$sqlr ='CREATE TEMPORARY TABLE rash_tmp  LIKE '.$rashsklad.''; 
#$sthr = $dbhr->do($sqlr);
...
# ЦЯ ПРОГРАММА НЕ ВИКОРИСТОВУЄТЬСЯ ПЕРЕНЕСЕНО У FINobnovny.cgi
...
$sqls = 'INSERT INTO '.$basenew.' (oc,coc,kc,ckc,booc,summa,idzak,idzakkc,kau,kaukc,idsimetr,doc,ceh1)';
